                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Silakan Pilih Target Penyelesaian"></i>
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <input class="form-control form-control-solid ps-12" placeholder="Select a date" name="todolist-duedate-tambah" id="todolist-duedate-tambah" required/>
                            </div> 
                        </div>
                        <div class="col-md-6">
                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
