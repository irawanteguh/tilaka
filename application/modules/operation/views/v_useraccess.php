<input type="hidden" id="userid_mapping" name="userid_mapping">
...
<div class="row gy-5 g-xl-8 mb-xl-8">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body">
                <div id="kt_docs_search_handler_position" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="true" data-kt-search-layout="inline" data-kt-search="true" class="">
                    ...
                    <div>
                        <div class="mh-450px scroll-y me-n5 pe-5" id="listuser" data-kt-search-element="results"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-7">
        <div class="card card-flush">
            <div class="card-header pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Master Role</span>
                    <span class="text-muted mt-1 fw-bold fs-7" id="headerlistrole">List Detail User :</span>
                </h3>
                <div class="card-toolbar">
                </div>
            </div>
